...
import { getCurrentWallet, connectWallet, checkNetwork } from "../../core/nft/interact";
    ...
    <header id="myHeader" className='navbar white'>
     <div className='container'>
       <div className='row w-100-nav'>
            ...
            <input id="quick_search" className="xs-hide" name="quick_search" placeholder="search item here..." type="text" />
              ...
              <BreakpointProvider>
                <Breakpoint l down>
                  {showmenu && 
                  <div className='menu'>
                    <div className='navbar-item' onClick={() => handleNav(!showmenu)}>
                ...
                <Breakpoint xl>
                  <div className='menu'>
                    ...
                    <div className='navbar-item' onClick={() => handleNav(!showmenu)}>
                      <NavLink to="/Artist"> Artist <span className='lines'></span></NavLink>
                    </div>
                    <div className='navbar-item' onClick={() => handleNav(!showmenu)}>
        ...
        <button className="nav-icon" onClick={() => handleNav(!showmenu)}>
