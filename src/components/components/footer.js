...
const GlobalStyles = createGlobalStyle`
    ...
    .social-icons span:hover {
        text-shadow: none;
        color: #fff !important;
        box-shadow: 2px 2px 20px 0px rgba(84 , 102, 249, 1);
        background: #5466f9;
        padding: 10px 10px 8px;
        width: 34px;
        height: 34px;
                            ...
                            <div className="de-flex">
                                <div className="de-flex-col">
                                    <span onClick={()=> window.open("", "_self")}>
                                        <img alt="" className="f-logo d-1" src="./img/Spectra_logo.png" style={{width: '60px'}}/>
                                        <img alt="" className="f-logo d-3" src="./img/Spectra_logo_light.png" style={{width: '60px'}}/>
                                        <img alt="" className="f-logo d-4" src="./img/Spectra_logo_mark_only.png" style={{width: '60px'}}/>
                                        <span className="copy">&copy; Copy </span>
                                    </span>
                                </div>
                                <div className="de-flex-col">
